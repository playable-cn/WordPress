...
if (defined('UPDATER_FULL_DISABLED') && UPDATER_FULL_DISABLED) {
	...
	function update_nothing($a) {
		return null;
	}
	add_filter('pre_site_transient_update_core', 'update_nothing');
	add_filter('pre_site_transient_update_plugins', 'update_nothing');
	add_filter('pre_site_transient_update_themes', 'update_nothing');
